  ...
  return (
    <>
      ...
      >
        ...
        {isOpen && (
          <div className="absolute z-30  top-8 lg:top-6 grid w-full grid-cols-1 -translate-x-4 rounded-xl bg-white px-4 shadow-lg lg:w-[640px] lg:-translate-x-1/3 lg:grid-cols-2 lg:p-5">
            <div className="flex flex-col items-center py-4">
              {HoverCardContent.map((item) => {
                ...
                return (
                  <div className="flex gap-x-4 p-3">
                    ...
                    <div className="flex flex-col">
                      ...
                      <p className="text-sm font-normal text-cgrey-600">
                        {description}
                      </p>
                    </div>
                  </div>
            ...
            <div className="bg-[F9FAFB] p-5 pb-0">
              <div className="p-3">
                <img
      ...
      {isOpen && (
        <div className=" absolute right-0 top-10 w-[calc(100vw-32px)] bg-white">
          ...
          <div className="grid grid-cols-2 gap-x-6 gap-y-3 px-4 py-6">
            {SmallScreenMenuContent.map((list) => (
              <div>
                {list.map((item) => (
                  <p className=" font-semibold text-cgrey-600">{item}</p>
                ))}
              </div>
            ))}
          </div>
